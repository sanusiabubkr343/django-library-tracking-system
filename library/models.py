...
class Loan(models.Model):
    ...
    due_date = models.DateTimeField(
        null=True, blank=True, default=datetime((loan_date) + timedelta(days=14))
    )
    ...
    @property
    def get_14_days_ahead(self):
        # self.loan_date + datetime(14days)

        days_ahead = datetime(timedelta(self.loan_date) + timedelta(days=14))
        return days_ahead
